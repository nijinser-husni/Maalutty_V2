...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('❤️MAALUTTY_V2💙 WORKING ' + config.WORKTYPE + ' NOW 👻'));
            await conn.sendMessage(conn.user.jid, "❤️MAALUTTY💙 ɪꜱ ᴀʟʟ ꜱᴇᴛ", MessageType.text);
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__❤️MAAUTTY_V2💙_☠☠_[error] ' +
                                    '\n\n*👻 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
