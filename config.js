...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY ❤️MAALUTTY_V2💙' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '+91 9061753722' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '❤️MAALUTTY_V2💙' : process.env.BOT_NAME,
